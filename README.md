...
Hatch an egg and raise it through `hatchling → chick → fledgling → juvenile → adult` — every stage is a distinct hand-drawn pixel silhouette, not just a bigger copy of the last. Along the way:
