...
export async function savePet(pet) {
  const { data, error } = await requireClient()
    ...
    .update({
      ...
      toybox_active: pet.toybox_active,
      toy_buff_until: pet.toy_buff_until,
      toy_box_x: pet.toy_box_x,
      toy_box_y: pet.toy_box_y,
      has_grooming_kit: pet.has_grooming_kit,
      grooming_active: pet.grooming_active,
      grooming_kit_x: pet.grooming_kit_x,
      grooming_kit_y: pet.grooming_kit_y,
      has_treat_jar: pet.has_treat_jar,
      treat_jar_active: pet.treat_jar_active,
      treat_jar_x: pet.treat_jar_x,
      treat_jar_y: pet.treat_jar_y,
      ...
      night_light_y: pet.night_light_y,
