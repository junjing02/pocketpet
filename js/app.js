...
} from "./pet-sprites.js?v=113";
import { propSpriteHtml } from "./prop-sprites.js?v=113";
import * as db from "./supabase.js?v=113";
import { playSound, soundEnabled, setSoundEnabled, playMelody, stopMelody, isMelodyPlaying } from "./sound.js?v=113";
import { VERSION } from "./version.js?v=113";
