...
} from "./pet-sprites.js?v=82";
import * as db from "./supabase.js?v=82";
import { playSound, soundEnabled, setSoundEnabled, playMelody, stopMelody, isMelodyPlaying } from "./sound.js?v=82";
import { VERSION } from "./version.js?v=82";
