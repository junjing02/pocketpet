...
} from "./pet-sprites.js?v=75";
import * as db from "./supabase.js?v=75";
import { playSound, soundEnabled, setSoundEnabled, playMelody, stopMelody, isMelodyPlaying } from "./sound.js?v=75";
import { VERSION } from "./version.js?v=75";
