...
} from "./pet-sprites.js?v=80";
import * as db from "./supabase.js?v=80";
import { playSound, soundEnabled, setSoundEnabled, playMelody, stopMelody, isMelodyPlaying } from "./sound.js?v=80";
import { VERSION } from "./version.js?v=80";
