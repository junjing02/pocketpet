...
} from "./pet-sprites.js?v=81";
import * as db from "./supabase.js?v=81";
import { playSound, soundEnabled, setSoundEnabled, playMelody, stopMelody, isMelodyPlaying } from "./sound.js?v=81";
import { VERSION } from "./version.js?v=81";
