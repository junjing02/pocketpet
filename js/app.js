...
} from "./pet-sprites.js?v=74";
import * as db from "./supabase.js?v=74";
import { playSound, soundEnabled, setSoundEnabled, playMelody, stopMelody, isMelodyPlaying } from "./sound.js?v=74";
import { VERSION } from "./version.js?v=74";
